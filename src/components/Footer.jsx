  ...
  return (
    ...
    <FooterStyle>
      <img
              ...
              alt="로고"
            />
      UMC 6th KKIJUK<br/><br/>
      <SmallText>
        " 당신의 끼를 적어두세요 "<br/>
        <nameBox>
          <BoldText>PM</BoldText> 엎질  <BoldText>DESIGN</BoldText> 운히  <BoldText>WEB</BoldText> 카이트 모니 연두 퍼지  <BoldText>SERVER</BoldText> 테이프 넬리 노아 사이다<br/><br/>
        </nameBox>
        kkijuk30@gmail.com<br/>
        <logoBox>
          <img
