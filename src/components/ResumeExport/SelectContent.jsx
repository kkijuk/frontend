...
const Category = styled.div`
    ...
    background-color: ${(props) => (props.isSelected ? 'var(--gray-06, #F5F5F5)' : '#FFFFFF')}; /* 선택 여부에 따른 배경색 */
    cursor: pointer; 
`;
