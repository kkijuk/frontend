...
const ButtonOptions=()=>{
    ...
    const isHistoryListState = /^\/history\/list\/\d+$/.test(location.pathname);

    const handleEditClick=()=>{
        location.pathname === '/history/master' ? navigate('/history/master/rewrite') : navigate('/history/:id/rewrite')
    }
