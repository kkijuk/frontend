		...
		<BackgroundDiv>
			<BaseDiv>
				...
				<div style={{ width: '820px', position: 'relative', display: 'inline-block' }}>
					<SButton type="button" onClick={() => handleSButtonClick(3)}>
						전체
					</SButton>
					<SButton type="button" onClick={() => handleSButtonClick(0)}>
						작성중
					</SButton>
					<SButton type="button" onClick={() => handleSButtonClick(1)}>
						작성완료
					</SButton>
					<SButton type="button" onClick={() => handleSButtonClick(2)}>
						보관
					</SButton>
